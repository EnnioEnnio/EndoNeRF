#!/bin/bash -eux
#SBATCH --job-name=es_endoNeRF_train_StereoNet
...
/dhc/home/ennio.strohauer/conda3/envs/$cudaenv/bin/python run_endonerf.py --config configs/conf_cutting_tissues_twice_HITNet_StereoNet.txt
